        ...
        <div class="modal-dialog vertical-align-center" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mdl-body_fix" >
                    ...
                    <div  class="form-group input-group-sm">
                        <label class="label1">Porciento</label>
                        <input  type="text" class="form-control"  ng-model = "entity.percent" placeholder="numero valido...">
                        <div ng-if="retorno.percent"> <label class="retorno"><%retorno.percent[0]%></label></div>
                    </div>
                </div>
