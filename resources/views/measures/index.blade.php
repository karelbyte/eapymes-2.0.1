@extends('layout')
@section('content')
    <div ng-controller="measures_ctrl">
        <div ng-include="helptpl"></div>
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6 col_fix"><h4>Listado de unidades de medidas.</h4></div>
        ...
        <!-- Visor de datos -->
            ...
            <div class="panel panel-default">
                <div class="panel-heading panel-heading_fix">
                    <div class="row ">
                        <div class="col-xs-8 col-sm-8 col-md-8 "> <eafieldorder display="UNIDAD DE MEDIDA" field="name" idfs="iname"></eafieldorder></div>
                ...
                <div class="panel-body pnl_fix">
                    <div ng-repeat="entity in lista"  ng-class="{'selectedtr':$index == selectedRow}"  ng-click="setClickedRow($index, entity.id)" class="row rowtable mouse div_hover">
                        <div class="col-xs-8 col-sm-8 col-md-8 text-justify"><%entity.name%></div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col_fix">
                            ...
                            <button class="btn btn-danger btn-xs" ng-click="setkill('Eliminar medida.',entity.id)" data-toggle='modal' data-target='#modal_delete'> <span class="glyphicon glyphicon-trash"></span></button>
                        </div>
                    </div>
                </div>
