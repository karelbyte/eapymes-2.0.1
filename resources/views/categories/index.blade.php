@extends('layout')
@section('content')
    <div ng-controller="categories_ctrl">
        <div ng-include="helptpl"></div>
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6 col_fix"><h4>Listado de categorias de productos.</h4></div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading panel-heading_fix">
                <div class="row ">
                    <div class="col-xs-8 col-sm-8 col-md-8  col-lg-8"> <eafieldorder display="CATEGORIAS" field="name" idfs="iname"></eafieldorder></div>
